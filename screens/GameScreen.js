...
export default class GameScreen extends PureComponent {
  ...
  constructor(props) {
    ...
    this.pusher = this.props.route.params.pusher;
    this.username = this.props.route.params.username;

    this.myChannel = this.props.route.params.myChannel
    this.opponentChannel = this.props.route.params.opponentChannel;

    this.isPlayerOne = this.props.route.params.isPlayerOne;

    const myPlankName = this.props.route.params.myPlank
    const opponentPlankName = this.props.route.params.opponentPlankName;

    this.myPlank = planks[myPlankName];
    this.opponentPlank = planks[opponentPlankName];

    this.myPlankColor = this.props.route.params.myPlankColor;
    this.opponentPlankColor = this.props.route.params.opponentPlankColor;

    this.opponentWall = this.props.route.params.opponentWall;
    this.myWall = this.props.route.params.myWall;

    const opponent = this.props.route.params.opponent;
